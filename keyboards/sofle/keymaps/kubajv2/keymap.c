...
[_QWERTY] = LAYOUT( \
  ...
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  TD(TD_CL), \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                 KC_LALT,KC_LGUI,KC_LCTRL, KC_LOWER, KC_ENT,      KC_SPC,  KC_RAISE, KC_RCTRL, KC_RGUI, KC_RALT \
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
  ...
  RESET  , XXXXXXX,KC_QWERTY,KC_COLEMAK,XXXXXXX,XXXXXXX,                     RGB_HUI, RGB_SAD, RGB_MODE_FORWARD, RGB_SAI, XXXXXXX, XXXXXXX, \
  XXXXXXX , XXXXXXX,XXXXXXX, XXXXXXX,    XXXXXXX,  XXXXXXX,                     XXXXXXX, RGB_VAD, XXXXXXX, RGB_VAI, XXXXXXX, XXXXXXX, \
